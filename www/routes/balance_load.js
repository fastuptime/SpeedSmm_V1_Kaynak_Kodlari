...
module.exports = function (app, checkAuth, checkBan, hesap, bildirim, balanceLoad, genel_log, genel_pcs, client, navbar) {
    ...
    app.post('/shipy/odeme', checkAuth, async (req, res) => {
        ...
        const fields = {
            ...
            "apiKey": "SHİPY_APİ_KEY" // Gizli API anahtarınız
        }
        console.log(fields);
    ...
    app.post('/shipy/callback', async (req, res) => {
        ...
        const hashString = ''+paymentID+returnID+paymentType+paymentAmount+paymentCurrency+"SHİPY_APİ_KEY";
        ...
        let userBalanceHistory = {
            ...
            genel_log.send({ content: `${kullanici._id} ' ID li kullanıcı bakiye yükledi. miktar ${paymentAmount}  SMM PANEL - Shipy` });
